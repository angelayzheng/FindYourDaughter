...
class ConfigurationTest(unittest.TestCase):
    ...
    def test_configuration_changes_detection_and_default_is_still_available(self):
        ...
        self.assertEqual(default, detect(weak, mask, detector="refined").daughters())
        tuned = detect(weak, mask, detector="baseline", parameters={"baseline": {"intensity_fraction": .35}})
